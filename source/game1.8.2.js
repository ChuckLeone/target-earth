...
function Background() {
	...
	this.draw = function() {
		...
		//this.context.fillRect(this.x, this.y, this.canvasHeight, this.canvasWidth);		
...
//   		this.bgContext.fillRect(0, 0, this.mainCanvas.width, this.mainCanvas.height);
